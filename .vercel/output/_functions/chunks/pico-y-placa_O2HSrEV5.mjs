import { g as getReglasPicoYPlaca } from './api_oxAjwbqA.mjs';
 ...
 */
async function puedeCircular(placa, fecha = new Date(), tipoVehiculoExento = false) {
  try {
 ...
 */
async function getEstadoPicoYPlaca(placa, tipoVehiculoExento = false, fecha = new Date()) {
  try {
    // Convertir la placa a mayúsculas
    placa = placa.toUpperCase();
...
export { getEstadoPicoYPlaca, puedeCircular };
